(self["webpackChunk_comprehensive_demo_app_02"] = self["webpackChunk_comprehensive_demo_app_02"] || []).push([[338],{
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    }, index_js_default().createElement(historyContext.Provider, {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    return index_js_default().createElement(Router, {
...
function Prompt(_ref) {
  ...
  return index_js_default().createElement(context.Consumer, null, function (context) {
    !context ?  false ? 0 : tiny_invariant_esm(false) : void 0;
    if (!when || context.staticContext) return null;
    var method = context.history.block;
    return index_js_default().createElement(Lifecycle, {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return index_js_default().createElement(context.Consumer, null, function (context$1) {
      ...
      return index_js_default().createElement(context.Provider, {
        value: props
      }, props.match ? children ? typeof children === "function" ?  false ? 0 : children(props) : children : component ? index_js_default().createElement(component, props) : render ? render(props) : null : typeof children === "function" ?  false ? 0 : children(props) : null);
    });
  };
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return index_js_default().createElement(Router, (0,esm_extends/* default */.Z)({}, rest, {
      history: history,
  ...
  _proto.render = function render() {
    ...
    return index_js_default().createElement(context.Consumer, null, function (context) {
      ...
      index_js_default().Children.forEach(_this.props.children, function (child) {
        if (match == null && index_js_default().isValidElement(child)) {
          element = child;
      ...
      return match ? index_js_default().cloneElement(element, {
        location: location,
        computedMatch: match
      }) : null;
    });
...
function withRouter(Component) {
  ...
  var C = function C(props) {
    ...
    return index_js_default().createElement(context.Consumer, null, function (context) {
      !context ?  false ? 0 : tiny_invariant_esm(false) : void 0;
      return index_js_default().createElement(Component, (0,esm_extends/* default */.Z)({}, remainingProps, context, {
...
var LinkAnchor = forwardRef(function (_ref, forwardedRef) {
  ...
  return index_js_default().createElement("a", props);
});
...
var NavLink = forwardRef$1(function (_ref, forwardedRef) {
  ...
  return index_js_default().createElement(context.Consumer, null, function (context) {
    ...
    return index_js_default().createElement(Link, props);
  });
});
